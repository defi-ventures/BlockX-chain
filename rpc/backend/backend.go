...
var _ Backend = (*ToknBackend)(nil)

// ToknBackend implements the Backend interface
type ToknBackend struct {
	ctx       context.Context
...
// New creates a new ToknBackend instance
func New(clientCtx clientcontext.CLIContext) *ToknBackend {
	return &ToknBackend{
...
func (b *ToknBackend) BlockNumber() (hexutil.Uint64, error) {
...
func (b *ToknBackend) GetBlockByNumber(blockNum rpctypes.BlockNumber, fullTx bool) (map[string]interface{}, error) {
...
func (b *ToknBackend) GetBlockByHash(hash common.Hash, fullTx bool) (map[string]interface{}, error) {
...
func (b *ToknBackend) HeaderByNumber(blockNum rpctypes.BlockNumber) (*ethtypes.Header, error) {
	height := blockNum.Int64()
	if height <= 0 {
		// get latest block height
		num, err := b.BlockNumber()
...
func (b *ToknBackend) HeaderByHash(blockHash common.Hash) (*ethtypes.Header, error) {
...
func (b *ToknBackend) GetTransactionLogs(txHash common.Hash) ([]*ethtypes.Log, error) {
...
func (b *ToknBackend) PendingTransactions() ([]*rpctypes.Transaction, error) {
	...
	for _, tx := range pendingTxs.Txs {
		...
		if err != nil {
			// ignore non Tokn EVM transactions
			continue
		}
...
func (b *ToknBackend) GetLogs(blockHash common.Hash) ([][]*ethtypes.Log, error) {
	res, _, err := b.clientCtx.Query(fmt.Sprintf("custom/%s/%s/%s", evmtypes.ModuleName, evmtypes.QueryHashToHeight, blockHash.Hex()))
	if err != nil {
		return nil, err
	}
...
func (b *ToknBackend) BloomStatus() (uint64, uint64) {
	return 4096, 0
}

// LatestBlockNumber gets the latest block height in int64 format.
func (b *ToknBackend) LatestBlockNumber() (int64, error) {
