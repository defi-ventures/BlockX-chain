...
// SupportedAlgorithms defines the list of signing algorithms used on Tokn:
...
func EthSecp256k1Options() []keys.KeybaseOption {
	return []keys.KeybaseOption{
		keys.WithKeygenFunc(ToknKeygenFunc),
...
// ToknKeygenFunc is the key generation function to generate secp256k1 ToECDSA
// from ethereum.
func ToknKeygenFunc(bz []byte, algo keys.SigningAlgo) (tmcrypto.PrivKey, error) {
