...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewToknApp(logger, db, nil, true, map[int64]bool{}, simapp.FlagPeriodValue, fauxMerkleModeOpt)
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewToknApp(log.NewNopLogger(), newDB, nil, true, map[int64]bool{}, simapp.FlagPeriodValue, fauxMerkleModeOpt)
...
func TestAppStateDeterminism(t *testing.T) {
	...
	for i := 0; i < numTimesToRunPerSeed; i++ {
		...
		app := NewToknApp(logger, db, nil, true, map[int64]bool{}, simapp.FlagPeriodValue, interBlockCacheOpt())
