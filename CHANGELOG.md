...
* (types) [\#503](https://github.com/cosmos/ethermint/pull/503) The `types.DenomDefault` constant for `"atokn"` has been renamed to `types.AttoTokn`.
...
* (types) [\#434](https://github.com/cosmos/ethermint/issues/434) Update default denomination to Atto Tokn (`atokn`).
...
* (types) [\#507](https://github.com/cosmos/ethermint/pull/507) Fix hardcoded `atokn` on `EthAccount` balance getter and setter.
